...
const Hero = () => {
  return (
    <div className="relative "> 
      ...
      "Remembering to take medications isn’t easy as we grow older.<br></br> But we deliver the best solution to help you stay on track with your medication.<br></br> Stay healthy, stay reminded!"
      <div className='mt-[50px]'>
        <button className='text-black rounded-2xl bg-[#0cb8b6] p-2 text-2xl'>Learn More</button><button className='text-black rounded-2xl bg-[#0cb8b6] p-2 ml-[20px] text-2xl'>Sign In</button>
      </div>
      </div>
